...
/**
 * Account number is intentionally excluded - changing the destination
 * account of an existing beneficiary record is a re-onboarding event,
 * not an update. Create a new beneficiary instead.
 */
@Getter
@Setter
@Builder
